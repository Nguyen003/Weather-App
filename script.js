const apiKey = 'e6b52d96ac3b644d611383e034ba9d7a';
...
function fetchWeatherData(location) {
    ...
    fetch(apiUrl).then(response => response.json()).then(data => {
        ...
        for(const dayData of nextDaysData) {
            ...
            // Ensure the day isn't duplicate anf today
...
// Fetch weather data on document load for default location (Geramany)
